...
public class Shorts extends Producto implements Serializable {
    ...
    @Override
    public int getStock() {
        return super.getStock(); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/OverriddenMethodBody
    }

    @Override
    public int getPedido() {
        return super.getPedido(); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/OverriddenMethodBody
    }
    ...
    public void setStock(int stock) {
        super.setStock(stock); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/OverriddenMethodBody
    }

    @Override
    public void setPedido(int Pedido) {
        super.setPedido(Pedido); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/OverriddenMethodBody
    }
